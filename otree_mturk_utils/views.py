    ...
    def __init__(self):
        ...
        def decorate_is_displayed(func):
            def decorated_is_display(*args, **kwargs):
                ...
                exiter = self.player.participant.vars.get('go_to_the_end', False) or self.player.participant.vars.get('skip_the_end_of_app_{}'.format(app_name), False) or  self.player.participant.vars.get('skip_the_end_of_app_{}_round_{}'.format(app_name , round_number), False) and not self.player.participant.vars.get('dropout', False)
